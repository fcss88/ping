...
# Use Systems Manager Session Manager (recommended)
aws ssm start-session --target i-1234567890abcdef0

# Or use SSH (requires key pair and security group rule)
...
psql -h your-db-endpoint -U admin -d appdb
💰 Cost Estimation
...
Solution: Check AWS quota limits
